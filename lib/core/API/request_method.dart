...
import 'package:quizo_flutter/core/API/request_on_progress_provider.dart';
...
class _ApiBaseHelper {
  ...
  Future<dynamic> httpSendRequest() async {
    ...
    if(!haveConnection) {
        throw ServerException(
          ...
          statusCode: 0,
          statusMessage: Strings.noInternetConnection,
  ...
  static Future<dynamic> _returnResponse(int statusCode,String resStream,RequestApi requestApi) async {
    if(statusCode == 401){
      ToastHelper.showError(message: Strings.status401Message);
